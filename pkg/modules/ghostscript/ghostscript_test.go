...
func TestGhostscript_Merge(t *testing.T) {
	for i, tc := range []struct {
	...
	}{
		{
			ctx: context.TODO(),
			inputPaths: []string{
				"/tests/test/testdata/ghostscript/sample1.pdf",
			},
		},
		{
			ctx: context.TODO(),
			inputPaths: []string{
				"/tests/test/testdata/ghostscript/sample1.pdf",
				"/tests/test/testdata/ghostscript/sample2.pdf",
			},
		},
		{
			ctx:       nil,
...
func TestGhostscript_Convert(t *testing.T) {
	for i, tc := range []struct {
	...
	}{
		{
			...
			inputPath: "/tests/test/testdata/ghostscript/sample1.pdf",
		},
		{
			ctx: context.TODO(),
		...
		},
		{
			ctx: context.TODO(),
			format: gotenberg.FormatPDFA1b,
			inputPath: "/tests/test/testdata/ghostscript/sample2.pdf",
		},
		{
			ctx: context.TODO(),
			format: gotenberg.FormatPDFA1a,
